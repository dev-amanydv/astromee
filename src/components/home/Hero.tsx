    ...
    >
      ...
      <div className="relative z-10 grid lg:grid-cols-12 gap-6 lg:gap-8 items-center">
        <div className="lg:col-span-7 space-y-4 sm:space-y-5 text-center lg:text-left">
          <div className="inline-flex items-center gap-1.5 sm:gap-2 bg-white/90 border border-amberGold-300 rounded-full px-3 sm:px-4 py-1.5 text-[11px] sm:text-xs text-amberGold-800 font-bold shadow-xs">
            <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse"></span>
            <span>100% Confidential • Verified Vedic Astrologers</span>
          </div>

          <h2 className="font-serif text-2xl sm:text-5xl lg:text-5xl font-black leading-tight tracking-tight text-darkSlate-900">
            Unlock Your Destiny with India&apos;s Top Astrologers at{' '}
            <span className="gold-gradient-text font-serif">₹1 / Min</span>
          </h2>

          <p className="text-darkSlate-600 text-xs sm:text-base max-w-2xl font-medium leading-relaxed">
          ...
          <div className="pt-2 flex flex-col sm:flex-row gap-3 sm:gap-3.5 justify-center lg:justify-start">
            <button
              onClick={() => scrollToSection('astrologersSection')}
              className="gold-gradient-bg hover:opacity-95 text-white font-extrabold px-5 sm:px-7 py-3 sm:py-3.5 rounded-2xl active:scale-95 transition-all flex items-center justify-center gap-2.5 text-xs sm:text-sm shadow-lg shadow-amberGold-500/30"
            >
            ...
            <button
              ...
              className="bg-white hover:bg-amberGold-50 border-2 border-amberGold-300 text-amberGold-800 font-extrabold px-5 sm:px-6 py-3 sm:py-3.5 rounded-2xl active:scale-95 transition-all text-xs sm:text-sm flex items-center justify-center gap-2.5 shadow-xs"
            >
          ...
          <div className="pt-4 sm:pt-6 grid grid-cols-3 gap-2 sm:gap-4 border-t border-amberGold-200/80 w-full max-w-lg mx-auto lg:mx-0">
            ...
            <div className="text-left border-l border-amberGold-200 pl-2 sm:pl-4">
              <div className="font-black text-base sm:text-lg text-amberGold-600 flex items-center gap-1">
                <span>4.9★</span>
                <i className="fa-solid fa-star text-xs"></i>
              </div>
              <div className="text-[10px] sm:text-[11px] text-darkSlate-500 font-semibold">2M+ Consults</div>
            </div>
            <div className="text-left border-l border-amberGold-200 pl-2 sm:pl-4">
              <div className="font-black text-base sm:text-lg text-emerald-600 flex items-center gap-1">
                <i className="fa-solid fa-shield-check text-sm sm:text-base"></i>
                <span>100%</span>
              </div>
              <div className="text-[10px] sm:text-[11px] text-darkSlate-500 font-semibold">Private &amp; Secure</div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-5 flex justify-center">
          <div className="relative w-full max-w-md">
            <div className="hidden sm:block absolute -inset-4 rounded-3xl border-2 border-dashed border-amberGold-300/60 animate-spin-slow pointer-events-none"></div>

            <div className="cosmic-card rounded-3xl p-4 sm:p-5 border-2 border-amberGold-300 relative bg-white/95 space-y-4">
